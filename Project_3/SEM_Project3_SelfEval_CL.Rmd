...
<span style="color:orange"> **Changed from** </span> `PSCS_fit$summaries %>% unlist()` <span style="color:orange"> **(which provided much more than just CFI, TLI, RMSEA, and 90% CI of RMSEA)** </span> 
```{r}
...
- The metric model (CFI = 0.969; $\chi^2$ = 1042.748) did improve the model fit compared to the scalar model (the more restrictive model; CFI = 0.962, $\chi^2$ = 1093.370). Therefore, there is  <span style="color:orange"> **not enough** </span> evidence for the scalar invariance. 
...
<span style="color:orange"> **Changed from** </span> `PSCS.MI.PartialScalar.fit$summaries %>% unlist()` <span style="color:orange"> **(which provided much more than just CFI, TLI, RMSEA, and 90% CI of RMSEA)** </span> 
...
<span style="color:orange"> **By CFI and TLI, the model fit did not improve by the metric invariance. They are the same between the partial-scalar invariance model and the metric invariance model. AIC, BIC, and aBIC indicate that the partial-scalar invariance model is preferred. Therefore, these results support the partial-scalar invariance model.** </span>  
...
<span style="color:orange"> **Revised calculation:** </span>  

```{r}
pchisq((1072.590-1042.739), (856-831), lower.tail = FALSE)
```
...
<span style="color:orange"> **Changed from** </span> `PSCS.MI.PartialScalar02.fit$summaries %>% unlist()` <span style="color:orange"> **(which provided much more than just CFI, TLI, RMSEA, and 90% CI of RMSEA)** </span> 
...
<span style="color:orange"> **Revised calculation:** </span>  
```{r}
pchisq((1082.946-1042.739), (857-831), lower.tail = FALSE)
```
...
<span style="color:orange"> **Changed from** </span> `PSCS.MI.PartialScalar05.fit$summaries %>% unlist()` <span style="color:orange"> **(which provided much more than just CFI, TLI, RMSEA, and 90% CI of RMSEA)** </span> 
...
```{r}
pchisq((1079.941-1042.739), (857-831), lower.tail = FALSE)
```
